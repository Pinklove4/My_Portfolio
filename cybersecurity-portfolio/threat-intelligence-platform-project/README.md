...
SOC needs consolidated IOC repository and ATT&CK mapping to improve detection coverage.
...
MISP-like workflow, Splunk, Python, STIX/TAXII concepts
...
Ingest feeds, deduplicate indicators, confidence-score intel, map ATT&CK, push to SIEM detections.
...
Expire stale IOCs, automate enrichment, document source reliability, align to detection backlog.
