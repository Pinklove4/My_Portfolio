...
DNS logs show high-entropy subdomain requests and unusual TXT query volume from one endpoint.

## Primary Focus Areas

- Network detection, threat hunting
- Incident triage and evidence handling
- Detection and response improvement in a home-lab environment

## Tools Used

DNS logs, Splunk, Wireshark, Python
...
Profile baseline DNS traffic, detect anomalies, enrich domains, investigate endpoint behavior.
...
Sinkhole malicious domains, restrict resolver egress, create entropy-based alerts.
