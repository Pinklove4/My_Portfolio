# Secure Backup and Recovery Lab

## Enterprise Scenario

Ransomware tabletop highlights uncertainty around backup integrity and restore recovery times.
...
Backup software concepts, Windows/Linux restore testing
...
Define backup scope, verify immutable copies, perform restore drill, measure RTO/RPO.

## MITRE ATT and CK References

T1486 (resilience control)
...
Increase backup frequency for critical systems, isolate backup network, validate quarterly restores.
