...
Users report suspicious invoice emails with macro-enabled attachments and lookalike sender domains.

## Primary Focus Areas

- SOC triage, phishing response
- Incident triage and evidence handling
- Detection and response improvement in a home-lab environment

## Tools Used

Defender for Office, sandbox, Splunk, VirusTotal style IOC checks
...
Extract headers, analyze sender infrastructure, detonate attachment safely, scope recipients, issue comms.

## MITRE ATT and CK References

T1566.001, T1204.002, T1059.005
...
Block sender/domain, quarantine messages, disable risky macros, reinforce user awareness campaign.
