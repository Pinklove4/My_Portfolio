# SIEM Correlation Rule Project

## Project Objective
Practice building simple correlation logic for multi-event detection.

## Tools Used
Splunk, Wazuh, Python

## What I Practiced
Created sample correlation rules and tuned false positives from scanner traffic.
...
- Mock dashboard: ../../assets/screenshots/siem-correlation-rule-project-mock-dashboard.svg
- Mock screenshot (HTML): ../../assets/screenshots/siem-correlation-rule-project-mock-screen.html
...
## Resume Bullet
Built a simulated siem correlation rule project in a home-lab environment to practice alert triage, evidence review, and defensive remediation documentation.
