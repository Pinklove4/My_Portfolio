...
## Project Objective
Practice triaging simulated endpoint alerts and documenting containment steps.

## Tools Used
Microsoft Defender, Sysmon, Wazuh, PowerShell

## What I Practiced
Reviewed Defender alerts, analyzed suspicious process trees, and tested endpoint quarantine workflow.
...
- Mock dashboard: ../../assets/screenshots/endpoint-detection-response-lab-mock-dashboard.svg
- Mock screenshot (HTML): ../../assets/screenshots/endpoint-detection-response-lab-mock-screen.html
...
## Resume Bullet
Built a simulated endpoint detection and response lab in a home-lab environment to practice alert triage, evidence review, and defensive remediation documentation.
