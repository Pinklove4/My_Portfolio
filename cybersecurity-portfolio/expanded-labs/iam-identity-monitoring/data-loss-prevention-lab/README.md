...
## Project Objective
Practice monitoring and documenting basic exfiltration indicators.

## Tools Used
DLP policy simulation, endpoint logs

## What I Practiced
Reviewed USB write events and tested policy block behavior.
...
- Mock dashboard: ../../assets/screenshots/data-loss-prevention-lab-mock-dashboard.svg
- Mock screenshot (HTML): ../../assets/screenshots/data-loss-prevention-lab-mock-screen.html
...
## Resume Bullet
Built a simulated data loss prevention lab in a home-lab environment to practice alert triage, evidence review, and defensive remediation documentation.
