...
## Project Objective
Practice compliance checks for BYOD-like scenarios.

## Tools Used
MDM concepts, conditional access notes

## What I Practiced
Reviewed device posture events and tested access policy outcomes.
...
- Mock dashboard: ../../assets/screenshots/mobile-device-security-project-mock-dashboard.svg
- Mock screenshot (HTML): ../../assets/screenshots/mobile-device-security-project-mock-screen.html
...
## Resume Bullet
Built a simulated mobile device security project in a home-lab environment to practice alert triage, evidence review, and defensive remediation documentation.
