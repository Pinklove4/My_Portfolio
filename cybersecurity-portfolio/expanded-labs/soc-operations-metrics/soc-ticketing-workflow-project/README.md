# SOC Ticketing Workflow Project

## Project Objective
Practice clean SOC handoff and escalation notes.

## Tools Used
Jira/ServiceNow style tickets, SIEM alerts

## What I Practiced
Created sample ticket lifecycle from triage to closure with severity tags.
...
- Mock dashboard: ../../assets/screenshots/soc-ticketing-workflow-project-mock-dashboard.svg
- Mock screenshot (HTML): ../../assets/screenshots/soc-ticketing-workflow-project-mock-screen.html
...
## Resume Bullet
Built a simulated soc ticketing workflow project in a home-lab environment to practice alert triage, evidence review, and defensive remediation documentation.
