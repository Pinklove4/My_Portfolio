# Security Dashboard Visualization Project

## Project Objective
Practice SOC metric tracking and analyst communication.

## Tools Used
Splunk dashboards, CSV metrics

## What I Practiced
Built dashboard views for alert trends, severity mix, and ticket backlog.
...
- Mock dashboard: ../../assets/screenshots/security-dashboard-visualization-project-mock-dashboard.svg
- Mock screenshot (HTML): ../../assets/screenshots/security-dashboard-visualization-project-mock-screen.html
...
## Resume Bullet
Built a simulated security dashboard visualization project in a home-lab environment to practice alert triage, evidence review, and defensive remediation documentation.
