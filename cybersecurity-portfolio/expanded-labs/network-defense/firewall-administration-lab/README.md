...
## Project Objective
Practice defensive firewall rule tuning in a home-lab network.

## Tools Used
pfSense, Suricata, Wireshark

## What I Practiced
Created allow/deny rules, reviewed blocked traffic, and tested IDS/IPS signatures.
...
- Mock dashboard: ../../assets/screenshots/firewall-administration-lab-mock-dashboard.svg
- Mock screenshot (HTML): ../../assets/screenshots/firewall-administration-lab-mock-screen.html
...
## Resume Bullet
Built a simulated firewall administration lab in a home-lab environment to practice alert triage, evidence review, and defensive remediation documentation.
