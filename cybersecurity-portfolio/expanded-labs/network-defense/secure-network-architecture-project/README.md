...
## Project Objective
Practice segmentation and controlled network trust boundaries.

## Tools Used
VLANs, pfSense, VPN, Nmap

## What I Practiced
Built zone model, tested inter-zone ACLs, and documented least-privilege pathways.
...
- Mock dashboard: ../../assets/screenshots/secure-network-architecture-project-mock-dashboard.svg
- Mock screenshot (HTML): ../../assets/screenshots/secure-network-architecture-project-mock-screen.html
...
## Resume Bullet
Built a simulated secure network architecture project in a home-lab environment to practice alert triage, evidence review, and defensive remediation documentation.
