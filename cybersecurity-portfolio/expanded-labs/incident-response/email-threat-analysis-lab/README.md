...
## Project Objective
Practice phishing triage workflow in a simulated inbox scenario.

## Tools Used
Defender for Office concepts, sandbox workflow, Splunk

## What I Practiced
Reviewed headers, assessed attachments safely, and documented investigation notes.
...
- Mock dashboard: ../../assets/screenshots/email-threat-analysis-lab-mock-dashboard.svg
- Mock screenshot (HTML): ../../assets/screenshots/email-threat-analysis-lab-mock-screen.html
...
## Resume Bullet
Built a simulated email threat analysis lab in a home-lab environment to practice alert triage, evidence review, and defensive remediation documentation.
