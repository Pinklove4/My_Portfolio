...
## Project Objective
Practice cloud incident triage for IAM misuse indicators.

## Tools Used
AWS CloudTrail, IAM review, Splunk

## What I Practiced
Reviewed CloudTrail events and tested key rotation response steps.
...
- Mock dashboard: ../../assets/screenshots/cloud-incident-response-project-mock-dashboard.svg
- Mock screenshot (HTML): ../../assets/screenshots/cloud-incident-response-project-mock-screen.html
...
## Resume Bullet
Built a simulated cloud incident response project in a home-lab environment to practice alert triage, evidence review, and defensive remediation documentation.
