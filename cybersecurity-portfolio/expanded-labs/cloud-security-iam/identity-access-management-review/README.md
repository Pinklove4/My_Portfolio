...
## Project Objective
Practice least-privilege review of simulated identity setup.

## Tools Used
AWS IAM, Azure RBAC concepts, PowerShell

## What I Practiced
Reviewed role permissions and documented over-permission findings.
...
- Mock dashboard: ../../assets/screenshots/identity-access-management-review-mock-dashboard.svg
- Mock screenshot (HTML): ../../assets/screenshots/identity-access-management-review-mock-screen.html
...
## Resume Bullet
Built a simulated identity and access management review in a home-lab environment to practice alert triage, evidence review, and defensive remediation documentation.
