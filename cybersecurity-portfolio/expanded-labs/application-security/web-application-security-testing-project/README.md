...
## Project Objective
Practice beginner web testing and secure coding recommendations.

## Tools Used
Burp Suite Community, OWASP test lab

## What I Practiced
Tested simulated input flaws and documented defensive fixes only.
...
- Mock dashboard: ../../assets/screenshots/web-application-security-testing-project-mock-dashboard.svg
- Mock screenshot (HTML): ../../assets/screenshots/web-application-security-testing-project-mock-screen.html
...
## Resume Bullet
Built a simulated web application security testing project in a home-lab environment to practice alert triage, evidence review, and defensive remediation documentation.
