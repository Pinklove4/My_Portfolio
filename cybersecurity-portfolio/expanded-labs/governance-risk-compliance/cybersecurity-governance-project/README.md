...
## Project Objective
Practice foundational security governance documentation.

## Tools Used
Policy templates, risk register, awareness plan

## What I Practiced
Drafted policy excerpts, built simple risk register, and tracked control owners.
...
- Mock dashboard: ../../assets/screenshots/cybersecurity-governance-project-mock-dashboard.svg
- Mock screenshot (HTML): ../../assets/screenshots/cybersecurity-governance-project-mock-screen.html
...
## Resume Bullet
Built a simulated cybersecurity governance project in a home-lab environment to practice alert triage, evidence review, and defensive remediation documentation.
