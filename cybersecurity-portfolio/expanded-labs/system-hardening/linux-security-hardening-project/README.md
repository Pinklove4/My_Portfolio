...
## Project Objective
Practice hardening Linux authentication and logging.

## Tools Used
Ubuntu, Fail2Ban, auditd, OpenSSH

## What I Practiced
Hardened SSH, reviewed auth logs, and validated audit events after policy updates.
...
- Mock dashboard: ../../assets/screenshots/linux-security-hardening-project-mock-dashboard.svg
- Mock screenshot (HTML): ../../assets/screenshots/linux-security-hardening-project-mock-screen.html
...
## Resume Bullet
Built a simulated linux security hardening project in a home-lab environment to practice alert triage, evidence review, and defensive remediation documentation.
