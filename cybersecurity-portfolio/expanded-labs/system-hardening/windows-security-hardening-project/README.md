...
## Project Objective
Practice defensive endpoint baseline improvements.

## Tools Used
Windows Defender, Local Security Policy, BitLocker

## What I Practiced
Configured policy controls, tested lockout behavior, and reviewed Event Viewer evidence.
...
- Mock dashboard: ../../assets/screenshots/windows-security-hardening-project-mock-dashboard.svg
- Mock screenshot (HTML): ../../assets/screenshots/windows-security-hardening-project-mock-screen.html
...
## Resume Bullet
Built a simulated windows security hardening project in a home-lab environment to practice alert triage, evidence review, and defensive remediation documentation.
