...
## Project Objective
Practice user behavior investigation in a simulated misuse case.

## Tools Used
File access logs, SIEM, PowerShell

## What I Practiced
Compared normal vs unusual file access patterns and documented findings.
...
- Mock dashboard: ../../assets/screenshots/insider-threat-investigation-mock-dashboard.svg
- Mock screenshot (HTML): ../../assets/screenshots/insider-threat-investigation-mock-screen.html
...
## Resume Bullet
Built a simulated insider threat investigation in a home-lab environment to practice alert triage, evidence review, and defensive remediation documentation.
