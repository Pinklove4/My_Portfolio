# DNS Threat Monitoring Lab

## Project Objective
Practice identifying suspicious DNS patterns.

## Tools Used
Wireshark, DNS logs, Splunk

## What I Practiced
Investigated high-entropy queries and reviewed resolver logs for anomalies.
...
- Mock dashboard: ../../assets/screenshots/dns-threat-monitoring-lab-mock-dashboard.svg
- Mock screenshot (HTML): ../../assets/screenshots/dns-threat-monitoring-lab-mock-screen.html
...
## Resume Bullet
Built a simulated dns threat monitoring lab in a home-lab environment to practice alert triage, evidence review, and defensive remediation documentation.
