# Threat Intelligence Platform Project

## Project Objective
Practice IOC organization and ATT&CK mapping.

## Tools Used
MISP-style workflow, CSV IOC feeds, Splunk

## What I Practiced
Ingested sample threat feeds and linked indicators to simple detections.
...
- Mock dashboard: ../../assets/screenshots/threat-intelligence-platform-project-mock-dashboard.svg
- Mock screenshot (HTML): ../../assets/screenshots/threat-intelligence-platform-project-mock-screen.html
...
## Resume Bullet
Built a simulated threat intelligence platform project in a home-lab environment to practice alert triage, evidence review, and defensive remediation documentation.
