...
Internal portal is suspected vulnerable to input validation flaws and session management weaknesses.
...
Burp Suite, OWASP Juice Shop style lab, Python
...
Map app surface, test OWASP scenarios safely, validate findings, report CVSS impact and fixes.
...
Add input sanitization, parameterized queries, CSP headers, secure cookie settings.
