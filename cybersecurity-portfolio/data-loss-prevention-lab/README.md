...
Sensitive HR documents are copied to removable media outside business hours by a privileged user.
...
DLP policy simulation, Windows logs, Splunk
...
Classify data labels, review USB events, correlate user activity, validate policy effectiveness.
...
Block unauthorized USB writes, enforce encryption, tighten least privilege, implement behavioral alerts.
