...
Multiple hosts display rapid file rename activity and suspicious SMB writes after compromised credentials.
...
Defender, Sysmon, Wazuh, SMB logs
...
Contain hosts, trace patient zero, review encryption timeline, assess lateral movement, support recovery.

## MITRE ATT and CK References

T1486, T1021.002, T1078, T1562
...
Segment affected subnet, restore from clean backups, rotate credentials, deploy ransomware behavior detections.
