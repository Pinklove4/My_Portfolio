...
RDP-exposed admin workstation has weak policy settings and incomplete disk protection controls.

## Primary Focus Areas

- Endpoint hardening, AD hygiene
- Incident triage and evidence handling
- Detection and response improvement in a home-lab environment

## Tools Used

Windows Server, Group Policy, Defender, PowerShell
...
Audit baseline, apply CIS-like controls, enforce BitLocker, harden RDP, validate via event logs.

## MITRE ATT and CK References

T1021.001, T1110, T1078
...
Enable MFA for admin access, restrict RDP source IPs, enforce Defender ASR rules, monitor policy drift.
