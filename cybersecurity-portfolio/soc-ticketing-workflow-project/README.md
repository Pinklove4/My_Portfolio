...
Analyst handoffs are inconsistent, causing missed SLA targets and duplicated triage effort.

## Primary Focus Areas

- SOC operations, process maturity
- Incident triage and evidence handling
- Detection and response improvement in a home-lab environment

## Tools Used

Jira, ServiceNow, Splunk alerts
...
Define severity matrix, create triage templates, simulate escalations, audit closure quality.
...
Standardize analyst notes, enforce required fields, implement QA review loop.
