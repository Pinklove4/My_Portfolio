...
CI pipeline deploys image with known vulnerabilities and overly permissive container runtime settings.
...
Docker, Trivy-style scanning, Kubernetes basics, Falco concepts
...
Scan images, review Dockerfile hardening, inspect runtime privileges, test policy enforcement.
...
Pin base images, drop root privileges, enforce admission controls, patch image dependencies.
