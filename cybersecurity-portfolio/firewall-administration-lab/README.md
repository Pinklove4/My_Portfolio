...
A branch firewall allows unexpected outbound traffic to known bad IP ranges, requiring emergency rule review.

## Primary Focus Areas

- Network defense, perimeter hardening
- Incident triage and evidence handling
- Detection and response improvement in a home-lab environment

## Tools Used

pfSense, Suricata, Wireshark, Python
...
Review rulebase, validate NAT behavior, inspect IDS alerts, test deny/allow outcomes, document change control.

## MITRE ATT and CK References

T1046, T1071.001, T1090
...
Implement deny-by-default egress, enable IPS blocking, create geo-IP blocks, add change approval checklist.
