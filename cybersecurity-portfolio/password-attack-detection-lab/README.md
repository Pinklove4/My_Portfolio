...
Authentication logs show spray-like attempts across many users from rotating IP addresses.
...
Detect burst patterns, correlate source ASN, check successful follow-on logins, classify risk.
...
Tune lockout policy, enforce MFA, block abusive IPs, alert on spray signatures.
