...
Multiple low-fidelity alerts hide true compromise activity unless correlated across identity and endpoint telemetry.

## Primary Focus Areas

- Detection engineering, SOC tuning
- Incident triage and evidence handling
- Detection and response improvement in a home-lab environment

## Tools Used

Splunk, Wazuh, Sigma, Python
...
Define hypothesis, normalize fields, build correlation logic, validate against test data, measure precision/recall.

## MITRE ATT and CK References

T1110, T1078, T1021, T1059
...
Deploy tuned rule pack, suppress known benign sources, introduce severity scoring, schedule monthly tuning.
