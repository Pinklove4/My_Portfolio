...
Defender for Endpoint raises ransomware behavior and suspicious PowerShell execution alerts on a finance workstation.

## Primary Focus Areas

- SOC operations, endpoint security, incident response
- Incident triage and evidence handling
- Detection and response improvement in a home-lab environment

## Tools Used

Microsoft Defender, Sysmon, Splunk, PowerShell
...
Validate alert fidelity, isolate host, review process tree, collect triage artifacts, classify incident severity.

## MITRE ATT and CK References

T1059.001, T1486, T1078, T1562.001
...
Quarantine endpoint, reset credentials, block indicators, tune EDR policy, validate re-image criteria.
