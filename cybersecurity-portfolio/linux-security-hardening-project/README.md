...
Ubuntu web server shows repeated SSH brute-force attempts and weak local privilege controls.
...
Linux, Fail2Ban, auditd, OpenSSH, Ansible
...
Baseline services, harden SSH, enforce sudo policy, deploy Fail2Ban, validate audit events.

## MITRE ATT and CK References

T1110, T1068, T1548.003
...
Disable password auth, enforce key-based login, limit sudoers, monitor auth failures, patch kernel regularly.
